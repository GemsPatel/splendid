    ...
    this.clickFile = function(e){
        axios.get( url+'/admin/media/file?id=' + e.target.getAttribute("atr") + '&thisFolder=' + document.getElementById('this-folder-id').value )
        // axios.post( url+'/admin/media/file', {
        //     id: e.target.getAttribute("atr"),
        //     thisFolder: document.getElementById('this-folder-id').value
        //   })
    ...
    this.folderChangeName = function(e){
        axios.get( url+'/admin/media/folder?id=' + e.target.getAttribute("atr") )
        .then(function (response) {
