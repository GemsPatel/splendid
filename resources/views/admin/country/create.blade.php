                                    ...
                                    <div class="card card-primary">
                                          ...
                                          <div class="card-body">
                                                <div class="form-group">
                                                      ...
                                                      <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('Country Name') }}" value="" autofocus>
                                                      @if($errors->has('name'))
                                                ...
                                                <div class="form-group ">
                                                      ...
                                                      <input type="text" class="form-control" id="sortname" name="sortname" placeholder="{{ __('Short Country Code') }}" value="">
                                                ...
                                                <div class="form-group ">
                                                      ...
                                                      <input type="text" class="form-control" id="symbol" name="symbol" placeholder="{{ __('Country Currency Symbol') }}" value="">
                                                ...
                                                <div class="form-group ">
                                                      ...
                                                      <input type="text" class="form-control" id="code" name="code" placeholder="{{ __('Country Phone Code') }}" value="">
                                                      @if($errors->has('code'))
