                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6">
                              ...
                              <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                    <form method="POST" action="{{route('admin.rating-comment.update', [$dataArr->id])}}">
                                          @csrf
                                          <div class="card-body">
                                                ...
                                                <div class="form-group clearfix">
                                                      <label for="rating" class="d-block">Name</label>
                                                      <div class="rate">
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <textarea class="form-control" id="comment" name="comment">{{$dataArr->comment}}</textarea>
