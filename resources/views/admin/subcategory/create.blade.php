                                          ...
                                          <div class="card-body">
                                                <div class="form-group">
                                                      ...
                                                      @if($errors->has('parent_id'))
                                                            <div class="error">The Category field is required.</div>
                                                      @endif
                                                </div>
                                                <div class="form-group">
                                                      <label for="title">Name</label>
                                                      <input type="text" class="form-control" id="title" name="title" placeholder="{{ __('Sub Category Name') }}" value="{{old('title')}}" autofocus onkeyup="getUrlName(this.value)">
                                                      @if($errors->has('title'))
                                                ...
                                                <div class="form-group d-none">
                                                      ...
                                                      <input type="text" class="form-control" id="alias_slug" name="slug" placeholder="{{ __('Slug') }}" value="{{old('slug')}}">
                                                </div>
                                                <div class="form-group">
