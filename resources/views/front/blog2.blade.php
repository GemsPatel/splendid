                    ...
                    <div class="box-widget-content">
                        <div class="banner-widget fl-wrap">
                            <div class="bg-wrap bg-parallax-wrap-gradien">
                                <div class="bg  " data-bg="{{url('public/img/bg/7.jpg')}}" style="background-image: url(&quot;{{url('public/img/bg/7.jpg')}}&quot;);"></div>
                            </div>
                                    ...
                                    <div class="tab">
                                        <div id="tab-popular" class="tab-content first-tab">
                                            <div class="post-widget-container fl-wrap">
                                                ...
                                                <div class="post-widget-item fl-wrap">
                                                    <div class="post-widget-item-media">
                                                        <a href="{{url('post-single')}}"><img src="{{url('public/img/all/thumbs/4')}}.jpg"  alt=""></a>
                                                    </div>
                                                    <div class="post-widget-item-content">
                                                        <h4><a href="{{url('post-single')}}">Innovations that Bring Aesthetic Pleasure to All.</a></h4>
                                                        <ul class="pwic_opt">
