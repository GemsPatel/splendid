        ...
        <div class="row">
            <div class="col-md-8">
                <div class="main-container fl-wrap fix-container-init">
                                    ...
                                    @if( isset( $prevBlog[0] ) )
                                        <a href="{{url('view/'.$prevBlog[0]['slug'])}}" class="single-post-nav_prev spn_box w-100">
                                            <div class="spn_box_img">
                                                <img src="{{url('storage/app/'.$prevBlog[0]['image'])}}" class="respimg" alt="{{$prevBlog[0]['title']}}">
                                            </div>
                                ...
                                <div class="col-md-6">
                                    @if( isset( $nextBlog[0] ) )
                                        <a href="{{url('view/'.$nextBlog[0]['slug'])}}" class="single-post-nav_next spn_box w-100">
                                            <div class="spn_box_img">
                                                <img src="{{url('storage/app/'.$nextBlog[0]['image'])}}" class="respimg " alt="{{$nextBlog[0]['title']}}">
                                            </div>
                                            <div class="spn-box-content">
                    ...
                    <div class="more-post-wrap fl-wrap hide">
