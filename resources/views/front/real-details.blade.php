...
<section class="hero-section">
    <div class="bg-wrap hero-section_bg">
        <div class="bg" data-bg="{{url('public/img/bg/9.jpg')}}"></div>
    </div>
    <div class="container">
        <div class="hero-section_title hs_single-post">
            <a class="post-category-marker color-bg" href="{{url('category')}}">Technology</a>
                ...
                <div class="main-container fl-wrap fix-container-init">
                    ...
                    <div class="single-post-content  fl-wrap">
                        ...
                        <div class="single-post-content_text" id="font_chage">
                            <div class="post-contents">
                                <div class="single-post-content_text_media fl-wrap">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p class="has-drop-cap">Today, i will give you list of commands for clear cache in laravel 7/6, clear config cache in laravel, clear route cache in laravel and clear view cache in laravel 7/6. i will give you all commands for clearing cache in laravel 7/6 application. you can also cache clear without command in laravel 7/6.</p>
                                        </div>
                                    </div>
                                </div>
                                <p>Sometime we need to cache clear when you change in configuration file or any thing change on view file after long time. so bellow command will help you to clear cache in laravel 7.</p>
                                <p>I want to share my experience and solution. when i was working on my laravel.</p>
                                <p>commerce website with gitlab. I was fetching one issue suddenly my view cache with error during development. i did try lot to refresh and something other but i can't see any more change in my view, but at last I did resolve my problem using laravel command so, let's see i added several command for clear cache from view, route, confir etc.</p>

                                <h4 class="mb_head">Clear Cache:</h4>
                                ...
                                <h4 class="mb_head">Clear Route Cache:</h4>
                                <blockquote class="w-100">
                                    <p> php artisan route:cache</p>
                                </blockquote>

                                <h4 class="mb_head">Clear View Cache:</h4>
                                <blockquote class="w-100">
                                    <p> php artisan view:clear</p>
                                </blockquote>

                                <h4 class="mb_head">Clear Config Cache:</h4>
                                <blockquote class="w-100">
                                ...
                                <blockquote class="w-100">
                                    <p> Route::get('/clear-cache-all', function() {</p>
                                    <p class="ml-15">Artisan::call('cache:clear');</p>
                                    <p class="ml-15">dd("Cache Clear All");</p>
                                    <p>}); </p>
                                </blockquote>
                            </div>
                        </div>
                        ...
                        <div class="single-post-nav fl-wrap">
                            <a href="{{url('post-single')}}" class="single-post-nav_prev spn_box">
                                <div class="spn_box_img">
                                    <img src="{{url('public/img/all/2.jpg')}}" class="respimg" alt="">
                                </div>
                            ...
                            <a href="{{url('post-single')}}" class="single-post-nav_next spn_box">
                                <div class="spn_box_img">
                                    <img src="{{url('public/img/all/20.jpg')}}" class="respimg" alt="">
                                </div>
                                <div class="spn-box-content">
                        ...
                        <ul class="commentlist clearafix">
                            <li class="comment">
                                <div class="comment-author">
                                    <img alt="" src="{{url('public/img/avatar/2.jpg')}}" width="50" height="50">
                                </div>
                            ...
                            <li class="comment comment_reply">
                                <div class="comment-author">
                                    <img alt="" src="{{url('public/img/avatar/4.jpg')}}" width="50" height="50">
                                </div>
                                <div class="comment-body smpar">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="grid-post-item     fl-wrap">
                                                <div class="grid-post-media gpm_sing">
                                                    ...
                                                    <div class="grid-post-media_title">
                                                        ...
                                                        <h4><a href="{{url('post-single')}}">Tesla it tested hypersonic Model-C</a></h4>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                <div class="grid-post-media gpm_sing">
                                                    <div class="bg-wrap">
                                                        <div class="bg" data-bg="{{url('public/img/all/41.jpg')}}"></div>
                                                        <div class="overlay"></div>
                                                    </div>
                                                    <div class="grid-post-media_title">
                                                        <a class="post-category-marker" href="{{url('category')}}">Politics</a>
                                                        <h4><a href="{{url('post-single')}}">Blue Origin practices with   orbital rocket in Florida</a></h4>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="grid-post-item  bold_gpi  fl-wrap">
                                                <div class="grid-post-media gpm_sing">
                                                    <div class="bg-wrap">
                                                        <div class="bg" data-bg="{{url('public/img/all/22.jpg')}}"></div>
                                                        <div class="overlay"></div>
                                                    </div>
                                                    <div class="grid-post-media_title">
                                                        <a class="post-category-marker" href="{{url('category')}}">Technology</a>
                                                        <h4><a href="{{url('post-single')}}">Scientific research goes to the next level</a></h4>
