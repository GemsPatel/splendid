...
this.croppImg = function (e) {
  ...
  axios.get( url+'/admin/media/file?id=' + self.croppFileId + '&thisFolder=' + document.getElementById('this-folder-id').value).then(function (response) {
...
module.exports = __webpack_require__(/*! E:\server\www\laravel\genti\resources\js\coreui\media-cropp.js */"./resources/js/coreui/media-cropp.js");
